...
- `Skill/Script Placement`: Skills own strategy, mode selection, evidence interpretation, coordination, and handoff; any executable used by humans, GitHub Actions, CI, root compositions, or multiple skills belongs in root `/scripts`, while co-located skill scripts remain agent-specific leaves.
