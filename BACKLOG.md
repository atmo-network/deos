...
| Mandatory execution and retry | **Canonical Service executes bounded zero-Step, effectful completion and Block-deadline retry paths in production; the mandatory hook now proves one public resident User Actor across adjacent Steps and Q1, but the same hook still retains the legacy FIFO drain.** | Make Service the sole ordinary drain and complete the public genuine-temporary-failure trace. |
