...
>
> Release boundary: `DEOS 0.7.8 — Reactive Delivery and Feedback Analysis` is the current framework line. Completed semantics and release evidence live in `CHANGELOG.md` and the owning DEOS Oracle, DEOS Router, AAA, control-plane, and architecture documents.
