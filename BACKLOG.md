...
| Canonical semantic/process/Service authority | **Implemented locally and production-reachable for Manual, AddressEvent, ObservationChange and scalar ObservationCrossing fire/rearm/coalesced/placed fire plus homogeneous pair rearm/coalesced/placed fire, maximum tail-page placed fire and emptied non-tail placed fire; generated owners exist for those occurrence boundaries; no complete end-to-end V1 proof.** | Convert the remaining Crossing trimmed non-tail batched path, AtTime, Cadenced, initial/resumed and post-attempt publication, then retire the FIFO consumer atomically. |
...
| Oracle publication | **Producer, ObservationChange and scalar ObservationCrossing fire/rearm/coalesced/placed fire plus homogeneous pair rearm/coalesced/placed fire, maximum tail-page placed fire and emptied non-tail placed fire are production-reachable; trimmed non-tail Crossing still lacks canonical generated-owner closure; final Oracle profile evidence incomplete.** | Canonicalize the remaining Crossing path and close one complete revision-safe producer-to-consumer profile. |
