...
| Mandatory execution and retry | **Canonical Service executes bounded zero-Step, effectful completion and Block-deadline retry paths in production, but the same hook still retains the legacy FIFO drain.** | Make Service the sole ordinary drain and prove one public resident User Actor across adjacent Steps and genuine temporary failure. |
