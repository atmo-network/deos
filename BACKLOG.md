...
| Canonical semantic/process/Service authority | **Implemented locally and production-reachable for Manual, AddressEvent and ObservationChange; generated owners exist for those occurrence boundaries; no complete end-to-end V1 proof.** | Convert ObservationCrossing, AtTime, Cadenced, initial/resumed and post-attempt publication, then retire the FIFO consumer atomically. |
...
| Oracle publication | **Producer and ObservationChange consumer paths are production-reachable; ObservationCrossing still uses legacy activation/control authority; final Oracle profile evidence incomplete.** | Canonicalize Crossing and close one complete revision-safe producer-to-consumer profile. |
