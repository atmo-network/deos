...
| Canonical semantic/process/Service authority | **Implemented locally and production-reachable for Manual, AddressEvent, ObservationChange and scalar ObservationCrossing fire/rearm/coalesced/placed fire plus homogeneous pair rearm/coalesced/placed fire and maximum tail-page placed fire; generated owners exist for those occurrence boundaries; no complete end-to-end V1 proof.** | Convert remaining Crossing non-tail batched paths, AtTime, Cadenced, initial/resumed and post-attempt publication, then retire the FIFO consumer atomically. |
...
| Oracle publication | **Producer, ObservationChange and scalar ObservationCrossing fire/rearm/coalesced/placed fire plus homogeneous pair rearm/coalesced/placed fire and maximum tail-page placed fire are production-reachable; non-tail batched Crossing paths still lack canonical generated-owner closure; final Oracle profile evidence incomplete.** | Canonicalize the remaining Crossing paths and close one complete revision-safe producer-to-consumer profile. |
