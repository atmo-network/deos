...
| Oracle publication | **Producer, ObservationChange and scalar ObservationCrossing fire/rearm plus homogeneous pair rearm are production-reachable; placed/coalesced Crossing cohort paths retain legacy activation/control authority; final Oracle profile evidence incomplete.** | Canonicalize the remaining Crossing paths and close one complete revision-safe producer-to-consumer profile. |
