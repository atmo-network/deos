...
| Deadline/Park/Pending mechanisms | **Decided and partially implemented/tested/resource-bound; not integrated end to end.** Canonical Service transfer now derives generation/plan Park authority from the admitted current Step and rejects incoherent Run, Step or resource state before mutation; bounded due return and exact Park wake remain staged. | Complete paid due/scan/check consumers and connect the proved transfers through real execution round trips. |
