...
| Canonical semantic/process/Service authority | **Implemented locally and production-reachable for Manual, AddressEvent, ObservationChange and scalar ObservationCrossing fire; generated owners exist for those occurrence boundaries; no complete end-to-end V1 proof.** | Convert Crossing cohort/rearm paths, AtTime, Cadenced, initial/resumed and post-attempt publication, then retire the FIFO consumer atomically. |
...
| Oracle publication | **Producer, ObservationChange and scalar ObservationCrossing fire paths are production-reachable; Crossing cohort/rearm paths retain legacy activation/control authority; final Oracle profile evidence incomplete.** | Canonicalize the remaining Crossing paths and close one complete revision-safe producer-to-consumer profile. |
