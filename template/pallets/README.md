...
The current pallet set is maintained against the repository's `Polkadot SDK 2603 / node 1.22.3` line. Most of the 2603 migration fallout landed in runtime/session/XCM integration surfaces rather than in pallet cores, and the pallet-local README files now record where pallet-specific cleanup was or was not needed.
