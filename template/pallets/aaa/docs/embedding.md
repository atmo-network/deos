...
- Governance/system origins, a two-dimensional hook weight meter, runtime-reserved `AaaOnIdleReserve`, owner-slot/queue/wakeup/active/total-identity/sweep bounds, `MaxOpeningSnapshotEntries`, `MaxIdleStarvationBlocks`, and fee constants.
