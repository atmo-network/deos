...
- Explicit cancellation, plan/policy/schedule replacement, deactivation, terminal transition, and pure close delete Continuation without compensation, prefix rollback, funding restoration, or sovereign-balance movement. A retained Active actor's cancellation exactly invalidates its live wakeup before any latched next-run signal is re-primed.
