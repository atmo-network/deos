...
Current generated component-wise admission permits four Crossing candidates per block. The reference 9,000-User population therefore requires at least 2,250 uncontended detector blocks, and 100 eligible blocks can materialize at most 400 candidates. The implementation does not satisfy the performance-assurance 10,000-User/100-block profiles; System schedule throughput and broad ObservationChange fanout do not substitute for that target.
