...
- `Validation / Release Evidence`: Added fast pull-request, heavy `main`, and full version-tag CI topology; made full regeneration compare exact worktree content; made clean client validation generate PAPI descriptors once without recursive install hooks; retained production-Wasm benchmark provenance; and prepared checksummed, attested release artifacts.
