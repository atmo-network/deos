...
Утверждения DEOS/TMCTOL не должны смешивать математику, симуляции, реализацию, управление и поведение рынка в одной фразе. Эта страница вводит локальную для wiki пояснительную шкалу классов доказательств; ее уровни не входят в канонические перечисления runtime или спецификаций. Alignment-аудит отдельно ведет небольшой реестр ключевых экономических утверждений с явно указанными видами доказательств.
