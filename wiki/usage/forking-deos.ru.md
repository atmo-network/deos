...
Счета-заявки исполнителей, распределение капитала по корзинам, ликвидность во владении протокола, защитные механизмы управления и топологии системных акторов — это механизмы. Форк может сохранить, переименовать, перенастроить, отключить или заменить отдельные политические решения, если честно сохраняет все гарантии, на которые продолжает ссылаться.
...
4. Проверьте роли системных акторов и удалите предпосылки, подходящие только эталонной экосистеме;
