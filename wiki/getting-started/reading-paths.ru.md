...
DEOS объединяет несколько связанных областей: устройство фреймворка, экономическую физику, автономных Actors, маршрутизацию, управление, стейкинг, проекции данных для чтения, клиент, инструменты и текущие ограничения. Необязательно изучать всё за один раз.
...
Вики описывает реализованную основу и её текущие ограничения. Открытые задачи относятся к `BACKLOG.md`, а завершённые изменения — к `CHANGELOG.md`, не к страницам вики.
