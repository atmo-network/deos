...
- **Автономные акторы**: Actors дает детерминированное исполнение и разреженное продолжение только для изменяемых акторов при временной недоступности среднего шага. Повтор сохраняет зафиксированный префикс и использует тот же ограниченный планировщик без отката всего плана.
