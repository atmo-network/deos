...
| `architecture-experiments` | Leaf/Synthesis proof graphs, frozen obligations, controlled production-Weight evidence, bounded comparative research against sealed baselines with outcome classes and finite stopping, progressive fission, artifact-bound lineage and bounded optimization gradients | Protocol semantics; benchmark command execution; open-work and architecture truth | `architecture-experiments/SKILL.md` |
