...
| Prove complete invalidation, no lost wakeup, no duplicate residence and generation-safe reclamation. | Actors specification §2.3 parking and generation rules | N3.3–N3.8, N4.2–N4.3, N5.3 | Hazard-specific closure routes and tests; syntax or graph reachability alone is insufficient. |
...
| CL-04 | [EXP-0117](./EXP-0117.md) | Qualified | N3.3–N3.8, N4.2, N5.2–N5.3 | Round/wake proof | N5.3 |
| CL-05 | [EXP-0120](./EXP-0120.md) | Current | N3.5, N3.8, N4.2, N5.2, N6.2 | Physical closure | N6.2 |
| CL-06 | [EXP-0121](./EXP-0121.md) | Qualified | N2.5, N3.2–N3.9, N5.1–N5.2 | Round/wake proof | N3.8, N3.9 |
| CL-07 | [EXP-0122](./EXP-0122.md) | Qualified | N2.5, N3.3–N3.9, N5.1–N5.2 | Round/wake proof | N3.8, N3.9 |
| CL-08 | [EXP-0123](./EXP-0123.md) | Qualified | N2.5, N3.4–N3.9, N5.1–N5.2 | Round/wake proof | N3.8, N3.9 |
| CL-09 | [EXP-0124](./EXP-0124.md) | Qualified | N2.5, N3.5–N3.9, N5.1–N5.2, N7.1 | Resource closure | N5.2, N3.9 |
| CL-10 | [EXP-0125](./EXP-0125.md) | Current | N3.6–N3.8, N4.2, N5.1–N5.3, N6.2, N7.1–N7.2 | Physical closure | N3.8 |
| CL-11 | [EXP-0126](./EXP-0126.md) | Current | N3.6, N3.8, N5.2–N5.3, N6.2, N7.1–N7.2 | Round/wake proof | N5.3 |
| CL-12 | [EXP-0127](./EXP-0127.md) | Qualified | N2.5, N3.7–N3.9, N5.1–N5.3, N6.2, N7.1–N7.2 | Round/wake proof | N3.9, N5.3 |
| CL-13 | [EXP-0128](./EXP-0128.md) | Current | N3.8, N4.1–N4.3, N5.1–N5.3, N6.2, N7.1–N7.2 | Physical closure | N5.3 |
| CL-14 | [EXP-0129](./EXP-0129.md) | Current | N4.1–N4.3, N5.1–N5.3, N6.2, N7.1–N7.2 | Physical closure | N5.3 |
| CL-15 | [EXP-0130](./EXP-0130.md) | Current | N4.2–N4.3, N5.1–N5.4, N6.2, N7.1–N7.2 | Physical closure | N5.3 |
| CL-16 | [EXP-0131](./EXP-0131.md) | Current | N4.3, N5.1–N5.4, N6.2–N6.3, N7.1–N7.2 | Resource closure | N5.2 |
| CL-17 | [EXP-0132](./EXP-0132.md) | Current | N5.1–N5.4, N6.2–N6.4, N7.1–N7.4 | Physical closure | N5.4 |
...
This is an intake routing ledger, not proof that a hazard is closed. `Applicable` means the current design carries the obligation now. `Conditional` activates only if the named mechanism or old quantitative premise is consumed. `Historical` preserves a rejected result without turning it into a current defect. `Reproduced defect` is reserved for a failure observed against the connected replacement implementation; none is currently classified that way. N5.3 is the single composed-review owner: implementation tasks provide the named prerequisite evidence, but only N5.3 may classify an applicable route as closed against its falsifier.

| Blocker | Classification | N5.3 closure route | Smallest falsifier | Prerequisite owner |
| --- | --- | --- | --- | --- |
| B1 — legacy placement authority | Known legacy finding | Prove one atomic semantic-writer/process cutover and absence of old authority or fallback. | One supported Publish, Replace, Remove, or service caller still reads or writes canonical identity, hot state, or admission through legacy placement. | N2.4 |
| B2 — partial-round insertion disagreement | Eliminated path | Preserve the ratified append-behind-current-residents oracle/carrier differential traces; no further implementation closure is inferred. | Any supported partial-round admission produces a different next-encounter order in the independent oracle and retained carrier. | N3.6 |
| B3 — disconnected carrier | Untested replacement hazard | Exercise ordinary dispatch through mandatory service, Step/retry, completion, admission, and settlement with complete owners. | Any supported ordinary Actor path bypasses the canonical carrier or uses a standalone owner as whole-service Weight. | N2.1–N3.6, N5.2 |
| B4 — parked-balance implementation gap | Untested replacement hazard | Implement and test the bounded complete source/review path for the fixed episode anchor and per-asset floor. | Any legal parked episode loses its fixed anchor, uses the wrong asset unit/floor, tracks busy movement, or wakes below threshold. | N2.5, N3.9 |
| B5 — credit provenance limit | Conditional | Keep net movement provenance-free; if N3.9 rejects the default, prove bounded whitelisted aggregate incoming credit without duplicate counting. | The default claims sender provenance, or the activated fallback counts an unknown source or one credit more than once. | N3.9 |
| B6 — producer/consumer gap | Known legacy finding | Connect one bounded publication-to-consumption round trip or remove/gate publication coherently before shipping. | A producer can commit a revision that no bounded enabled consumer can drain into the owning check/service path. | N3.1, N3.4, N3.7 |
| B7 — incomplete cleanup | Untested replacement hazard | Prove generation-safe mutation, interrupted sweep, saturation recovery, debt bounds, and funded mandatory progress. | Old-generation cleanup touches a replacement, loses debt/capacity, or requires idle-only progress. | N4.1–N4.3, N5.2 |
| B8 — retained-domain coverage | Known legacy finding plus untested replacement hazard | Identify every retained heap/selector/callback; prove deep/full/rollback coverage, or prove old-path elimination and equivalent replacement coverage. | One reachable retained or replacement path lacks a maximum/deep/refusal/rollback witness or complete composed charge. | N5.2, N7.2 |

B2 is the only eliminated blocker path and closes only the oracle/carrier order disagreement proved by N0.3. It does not discharge B3, round mutation, wake, capacity, or resource obligations. B1, B6 and the legacy part of B8 are known findings, not reproduced defects in V1; B3, B4, B7 and replacement coverage under B8 remain untested hazards until their connected implementation exists.

| Hazard | Disposition | Surviving or replacement responsibility | Closure route | Live owners |
| --- | --- | --- | --- | --- |
| H1 — deep temporal coverage | Applicable | Any retry, timed-review, sleep, or sweep cursor that remains reachable; replacement ring/wake/cleanup traversal if the old heap is removed. | N5.1 proves old-path elimination or identifies the surviving fallback; deep, maximum, interrupted, and total-accounting evidence covers every reachable replacement or retained cursor. | N3.3, N3.5, N3.7, N4.2, N5.1–N5.3 |
| H2 — full-capacity rearm | Applicable | Live, Sleep, Park, Pending, retirement-reserve, and cleanup admission at legal capacity. | Treat ordinary saturation as typed backpressure preserving one obligation; reserve mandatory revocation capacity; distinguish integrity failure from capacity refusal and prove recovery. | N3.8, N4.2–N4.3, N5.2–N5.3 |
| H3 — narrow multi-way rejection and wording | Historical; conditional on reuse | EXP-0118 remains only a rejection under its recorded premises; no current multi-way carrier is selected. | Preserve the historical result. If N6.2 consumes its structure or threshold, create a qualified current claim and revalidate the exact premise before selection. | N6.2 |
| H4 — sensitivity inconsistency | Conditional | Any fixed-trace comparison that credits removed publication, removal, or earlier charges. | Define the counterfactual accounting model before ranking, reconcile freed charges, and test the consumed arithmetic; otherwise make no quantitative reuse claim. | N6.3 |
| H5 — primary evidence inside the index | Applicable evidence-integrity rule | New decision-bearing measurements and independently decidable imported claims. | Keep new primary evidence in identified Leaves with exact consumers; the track index carries only projections and synthesis. | N6.2–N6.4, N7.3 |
| H6 — transient observations/prototypes | Applicable evidence-integrity rule | New samples, traces, fixtures, and candidate patches; unavailable historical bytes remain explicitly unavailable. | Retain exact decision-bearing identities and raw inputs where required, and qualify rather than reconstruct missing old evidence. | N6.3, N7.3 |
| H7 — mixed resource boundaries | Applicable | Every old or new reservation, settlement, proof, access, and workload percentage used by the selected design. | Requalify identities and keep requested/outstanding reservation, actual settlement, RefTime, ProofSize, logical access, and physical evidence separate. | N5.2, N6.3, N7.1 |
| H8 — selector/executor mismatch | Applicable | Every retained or replacement domain selector, including tail/non-tail and generic-host variants. | Require selector eligibility to imply executor-domain validity; preserve the fixed PR #32 regression where reachable and add equivalent replacement-domain falsifiers. | N5.3, N7.2 |
| H9 — stale current summaries | Applicable evidence-integrity rule | BACKLOG, current lineage, artifact bindings, architecture, Wiki, and release-facing claims. | Reconcile current identities and units at each freeze; never mutate the published tag or substitute queue entries, horizons, and absolute blocks. | N7.1, N7.3–N7.4 |
| Round reentry and frontier recapture | Applicable | Mutable persistent ring rounds across phase interruption, removal, admission, and generation replacement. | Prove immutable per-block round identity, independent Q1 guards, next-block eligibility, and no donated or recaptured turn under singleton, wrap, and partial-round mutation. | N3.6, N5.3, N7.2 |
| Lost wakeup and stale acknowledgment | Applicable | Park invalidation, Pending coalescing, callbacks, partial fanout, subscription mutation, and timed fallback. | Use atomic or monotone revisioned registration/evaluation/acknowledgment; acknowledge only the covered revision and preserve a newer or saturated durable obligation. | N3.3, N3.7, N5.3, N7.2 |
| Arbitrary unlink | Applicable | Head, tail, and interior owner/protocol removal from the selected carrier. | Select bounded removal authority, preserve round order and one obligation through rollback, and measure fragmented/full cases; never assume free predecessor discovery. | N3.5–N3.6, N3.8, N5.2–N5.3 |
| Duplicate residence | Applicable | Atomic Live/Sleep/Park/Pending movement and repeated hints at full capacity. | Secure destination or durable pending authority before source release, generation-bind every reference, coalesce hints, and assert exactly one canonical residence after every success/refusal/rollback. | N3.2, N3.7–N3.8, N5.3 |
| Sweep-generation interference | Applicable | Retired generation cleanup concurrent with owner update, recreation, wake, and residual index traversal. | Revoke old execution first; bind cleanup namespace/cursor to generation; prove an interrupted old sweep cannot remove, wake, or write the new generation and that mandatory progress is funded. | N4.2–N4.3, N5.3, N7.2 |

The H1–H9 rows each have one route-level falsifier: respectively an uncovered reachable deep cursor, unrecoverable legal saturation, reuse outside EXP-0118's exact premises, unreconciled fixed-trace arithmetic, primary evidence embedded only in this index, unretained decision-bearing bytes/identity, conflated resource units, selector admission outside executor validity, or a stale/misidentified current projection. N5.3 owns composed closure for applicable H1, H2, H7 and H8; N6.2, N6.3, N7.3 and N7.1 own activation or evidence-integrity closure for conditional/evidence-only H3–H6 and H9. No row is a reproduced V1 defect before the connected implementation exists.

Removal of the historical scheduler does not discharge H1 or H2 while any old deadline, retry, review, or sweep owner remains reachable. Conversely, H3 does not require modernizing EXP-0118's rejected carrier unless N6.2 deliberately reuses it. All five new-model hazards remain active regardless of candidate performance or rejection. Their smallest falsifiers are the first supported trace that respectively recaptures a round turn, loses or stale-acknowledges a wake, requires unbounded predecessor discovery, creates zero/duplicate residence, or lets an old sweep affect a replacement generation; N5.3 owns their composed closure after the listed implementation prerequisites land.
...
- [EXP-0120](./EXP-0120.md): Use the current initial geometry only: one stable actor-generation process owner, retained C6 body, sparse Run tiers, and compact generation-bound memberships whose physical cardinality follows supported occupancy. N3.5 realizes and measures one carrier, N3.8/N4.2 prove saturation and reclamation safety, N5.2 binds resources, and N6.2 opens an alternative only on the recorded falsifier.
- [EXP-0121](./EXP-0121.md): Use the selected discovery boundary for non-balance sources: direct Actor/account lookup, bounded shared-feed traversal, indexed deadlines, or deterministic timed review creates or proves one current-generation Pending check. For parked balance, apply the EXP-0137 semantic delta: only a configured asset's checked absolute net movement from the fixed final parking anchor reaching `max(authored minimum, 100 × asset minimum)` qualifies a signal; subthreshold changes remain parked.
- [EXP-0122](./EXP-0122.md): Use the selected return policy except that current predicate applicability alone does not return a parked-balance Actor. Work due no later than B + 1 remains Live under round/Q1 guards; only a known later deadline Sleeps, certified complete negative evidence Parks, and unacknowledged checks remain Pending. A qualifying parked-balance signal creates at most one check while not busy; completion re-evaluates and either Parks with a new fixed anchor or returns under ordinary round rules.
- [EXP-0123](./EXP-0123.md): Use the selected Park Certificate with generation/plan identity, typed negative reason, conservative exact dependency revisions and time boundaries. For parked balance, additionally bind configured watched assets, the fixed final parking anchor, direction and inclusive threshold; rearm after a negative check keeps that anchor, while a new anchor is installed only on initial/final parking. Event-driven Park still requires proved complete mutation coverage; otherwise deterministic review remains authoritative.
- [EXP-0124](./EXP-0124.md): Use one complete coalesced activation check as the negative-work atom, but do not charge or create it for a subthreshold parked-balance change or while the Actor is busy. The first qualifying signal arms one ordinary Pending check; later coalesced hints create none. Users secure its generated Trigger-control maximum, Systems consume bounded Actor Control allocation, and timed reviews require fresh authority. Numeric resources remain open in N5.2/N3.9.

- [EXP-0125](./EXP-0125.md): Use one stable Actor-generation process owner, an actor-keyed intrusive doubly linked service ring for Live/Pending, retained C32 deadline pages plus paged min-heaps for Sleep/Park reviews, process-owned Park evidence, and generation-bound reverse handles. Ordinary retained Live progress allocates no membership; arbitrary unlink is direct; N3.6–N3.8 must prove rounds, interleavings, and saturation before architecture changes.
- [EXP-0126](./EXP-0126.md): Use consensus block B as immutable round identity, one persistent next-encounter cursor, per-node `eligible_from`/`last_considered`, and independent process Q1. Stamp every B admission/reentry as considered and B + 1 eligible; stop at the first B marker; preserve a valid unaffordable head without frontier advance.
- [EXP-0127](./EXP-0127.md): Use checked nonwrapping source revisions and transactional evaluate/install/revalidate/acknowledge/remove-old ordering. Parked-balance rearm is a special fixed-anchor case: a negative check may acknowledge the covered notification revision but must not replace the parking balance anchor, so later net movement is still measured from the same episode baseline. Keep each shared traversal target fixed, retain newer revisions as the next target, and advance only after stale proof or durable generation-bound destination authority; exhaustion remains sticky and fail-closed.
- [EXP-0128](./EXP-0128.md): Use one transaction-local destination stage and one `Process.residence` linearization before exact source release. Ordinary saturation retains the unchanged source; mandatory revocation directly unlinks and leaves only a generation-bound process-local cleanup cursor funded from reserved Control, never an overflow queue or reserved ordinary membership slot.
- [EXP-0129](./EXP-0129.md): Keep Park as automatic negative evidence and use one process-owned `Serving`/typed `Disabled`/irreversible `Retired` discriminator. Revoke before detach; preserve committed Cycle/retry semantics and custody; admit revival only through exact cause authority, current-state reconstruction, generation/plan validation, and B + 1 eligibility.
- [EXP-0130](./EXP-0130.md): Seal one bounded retired-generation cleanup manifest and advance fixed exact-handle phases through one atomic cursor. Keep replacement namespaces disjoint, custody outside cleanup, release resources only after prove-empty finalization, and fund mandatory maintenance independently of idle work under debt admission below sustainable service.
- [EXP-0131](./EXP-0131.md): Secure every generation's maximum retained-byte hold and terminal-capacity bond before serving. Keep Disabled fully collateralized, convert retirement into exact classed debt, enforce component-wise payer/global hard limits, prohibit post-seal old references, and release only after separately funded canonical cleanup proves emptiness.
- [EXP-0132](./EXP-0132.md): Delete legacy latch, Opening snapshot, Ready/waiting-primary, successor-publication and unmetered fallback authority in one fresh-genesis cut. Route every supported source through the generation-bound process/residence machine while preserving custody, provider, fee and effect boundaries as non-scheduling owners.
...
- [EXP-0137](./EXP-0137.md): Keep one implementation baseline for stable process placement, the actor-keyed Live/Pending ring, exact revisioned Park lookup, C32 deadline pages/paged heaps and sealed reclamation. Its 2026-09-15 amendment separates mandatory structural/soundness correction from one finite performance-driven same-semantics alternative campaign, admitted only by a predeclared miss, complete applicable work, causal owner and concrete falsifiable mechanism.
...
- [EXP-0117](./EXP-0117.md): Import only the finding that deep temporal coverage and full-capacity rearm were not established for every reachable path in the old topology. N3.3–N3.8, N4.2 and N5.2–N5.3 consume this immediate hazard transfer for any surviving retry, review or sweep cursor; removal closes nothing until replacement coverage is proved.
...
| [EXP-0120](./EXP-0120.md) | 0.7.27 | Accepted | Leaf: Current-State Co-Access and Initial Stable Geometry | Current source access paths, generated descriptor bounds, and the N2.1–N2.5 vertical-slice semantics on baseline `4c1a56d2…` | Select one stable actor-generation process owner, sparse Run tiers, retained C6 Contract body, and compact generation-bound membership references; reject moving whole-process frames, Contract copies, monoliths, and historical-ID-indexed arrays | N3.5 carrier realization; N6.2 alternative gate |
| [EXP-0121](./EXP-0121.md) | 0.7.27 | Accepted | Leaf: Autonomous Discovery and Activation-Check Boundary | Current direct ingress, bounded observation fanout, temporal wake and Manual routes on baseline `853bacff…` | Select one generation-bound Pending check between bounded source hints and current applicability; reject population scans, unbounded fanout, event-history authority, dropped overload and indefinite parking under incomplete notifications | N3.2–N3.8 carrier implementation and N5.1/N5.2 closure |
| [EXP-0122](./EXP-0122.md) | 0.7.27 | Accepted | Leaf: Single-Residence Return Policy | Current §2.3 residence contract and independent semantic oracle on baseline `023ee065…` | Keep work due by B + 1 Live, Sleep only to a known later deadline, Park only under complete negative evidence, and retain Pending until check acknowledgment; reject Q1-only successor wakes and busy future-Cycle authority | N3.3–N3.8 realization and N5.1/N5.2 closure |
| [EXP-0123](./EXP-0123.md) | 0.7.27 | Accepted | Leaf: Complete Park Certificate and Wake Plan | Current predicate/read descriptors, evaluator semantics, capability matrix, and host mutation-boundary audit on baseline `e33e4137…` | Bind generation/plan, typed negative reason, exact dependency revisions and time boundaries; require closed-domain invalidation or one deterministic timed review, with generic balance/spendability incomplete by default | N3.4–N3.8 realization and N5.1/N5.2 closure |
| [EXP-0124](./EXP-0124.md) | 0.7.27 | Accepted | Leaf: Negative Work, Fairness, and Griefing Budget | Current fee/control specification and scheduler resource/refusal paths on baseline `c22006b0…` | Price one complete coalesced activation check through prepaid User Trigger-control authority or bounded System allocation; require fresh timed-review authority, strict FIFO, and typed refusal/fault separation | N3.5–N3.8 realization and N5.2 resource closure |
| [EXP-0125](./EXP-0125.md) | 0.7.27 | Accepted | Leaf: One Concrete Live/Sleep/Park/Pending Carrier | Current scheduler/storage source and EXP-0120–EXP-0124 on baseline `9ade5865…` | Select stable process plus actor-keyed doubly linked Live/Pending ring, retained paged deadline heap for Sleep/Park reviews, process Park evidence, and generation-bound reverse handles | N3.6–N3.8 realization, N4.2 cleanup, and N5.2 resource closure |
| [EXP-0126](./EXP-0126.md) | 0.7.27 | Accepted | Leaf: Immutable Block Round and Persistent Ring Frontier | EXP-0122/0124/0125 and N3.6 contract on baseline `bb8265cb…` | Select block identity plus distributed considered markers and persistent cursor; B admissions defer to B + 1, valid blocked heads retain the frontier, and arbitrary removal cannot donate/recapture a turn | N3.6/N3.8 realization and N5.2/N5.3 closure |
| [EXP-0127](./EXP-0127.md) | 0.7.27 | Accepted | Leaf: Monotone Dependency Acknowledgment and Lost-Wakeup Closure | Current-lineage source, certificate, carrier and round decisions on baseline `14123fa…` | Select checked revisions, transactional check/register/revalidate/acknowledge ordering, fixed-target dirty traversal, cursor retention until durable transfer, and sticky fail-closed exhaustion | N3.7/N3.8 realization and N5.2/N5.3 closure |
| [EXP-0128](./EXP-0128.md) | 0.7.27 | Accepted | Leaf: Atomic Residence Transfer and Saturation Recovery | Current-lineage carrier, round and lost-wakeup decisions on baseline `b2ea188…` | Select transaction-local destination staging, one process-discriminator linearization, source-retained typed refusal, direct revocation, generation-bound process-local cleanup, and mandatory Control reserve | N3.8/N4 realization and N5.2/N5.3 closure |
| [EXP-0129](./EXP-0129.md) | 0.7.27 | Accepted | Leaf: Revocation Status and Authorized Revival | Current-lineage lifecycle, carrier, round, lost-wakeup, and movement decisions on baseline `5c1a679…` | Select process-owned Serving/typed Disabled/irreversible Retired status, revoke-before-detach, committed-basis preservation, cause-authorized current-state revival, and generation isolation | N4 realization and N5.2/N5.3 closure |
| [EXP-0130](./EXP-0130.md) | 0.7.27 | Accepted | Leaf: Generation-Safe Bounded Cleanup | Current-lineage carrier, wake, movement, and revocation decisions on baseline `4dc17d83` | Select sealed generation-owned manifest, fixed exact-handle cleanup phases, atomic cursor progress, replacement isolation, prove-empty release, and funded sustainable maintenance | N4.2/N4.3 realization and N5.2/N5.3 closure |
| [EXP-0131](./EXP-0131.md) | 0.7.27 | Accepted | Leaf: Retained-State Collateral and Reclamation Debt | Current-lineage status and cleanup decisions on baseline `dd2185bb` | Select generation-held maximum bytes and terminal bond, classed hard-bounded debt, non-borrowable maintenance, post-seal immutability, and prove-empty release | N4.3 realization and N5.2/N5.3 closure |
| [EXP-0132](./EXP-0132.md) | 0.7.27 | Accepted | Leaf: Legacy Scheduler Elimination and Isolation Map | Current source reachability and current-lineage process/residence decisions on baseline `61865559` | Delete all old service authority without bridges, route supported paths through one generation-bound machine, and preserve custody/provider/fee/effect boundaries as non-scheduling owners | N5.1 implementation, N5.2/N5.3 resources and hazards, N5.4/N7 absence and generated-consumer closure |
...
| [EXP-0137](./EXP-0137.md) | 0.7.27 | Accepted | Leaf: Current-State Actors Physical-Choice Sufficiency Ledger | EXP-0120/EXP-0125/EXP-0135 selected architecture and EXP-0136 measurement boundary on baseline `d83bdb1` | Retain one implementation; require S correction for soundness defects; permit at most one qualified P campaign with one bounded refinement | N3–N5 realization, V1/V2 early ledger, N6.5 physical accounting, N6.3 whole-service decision and N7 review |
