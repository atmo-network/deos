...
| CL-06 | [EXP-0121](./EXP-0121.md) | Current | N3.2–N3.8, N5.1–N5.2 | Round/wake proof | N3.8 |
| CL-07 | [EXP-0122](./EXP-0122.md) | Current | N3.3–N3.8, N5.1–N5.2 | Round/wake proof | N3.8 |
| CL-08 | [EXP-0123](./EXP-0123.md) | Current | N3.4–N3.8, N5.1–N5.2 | Round/wake proof | N3.8 |
| CL-09 | [EXP-0124](./EXP-0124.md) | Current | N3.5–N3.8, N5.1–N5.2, N7.1 | Resource closure | N5.2 |
...
| CL-12 | [EXP-0127](./EXP-0127.md) | Current | N3.7–N3.8, N5.1–N5.3, N6.2, N7.1–N7.2 | Round/wake proof | N5.3 |
...
- [EXP-0121](./EXP-0121.md): Use the selected discovery boundary: direct Actor/account lookup, bounded shared-feed traversal, indexed deadlines, or deterministic timed review creates or proves one current-generation Pending check. A hint never authorizes an effect; current applicability alone parks, sleeps, or admits Live, and saturation retains typed backpressure rather than dropping the check.
- [EXP-0122](./EXP-0122.md): Use the selected return policy: work due no later than B + 1 remains Live under round/Q1 guards; only a known later deadline Sleeps, complete negative evidence Parks, and unacknowledged checks remain Pending. Completion and busy hints never create a second Cycle.
- [EXP-0123](./EXP-0123.md): Use the selected Park Certificate: bind the exact Actor generation and accepted plan, typed negative reason, conservative exact dependency revisions, and time boundaries. Event-driven Park requires a proved closed mutation domain; otherwise one deterministic timed review remains authoritative. Generic balance/spendability is not event-complete by default.
- [EXP-0124](./EXP-0124.md): Use one complete coalesced activation check as the negative-work atom: Users secure its generated Trigger-control maximum before Pending materialization, Systems consume bounded Actor Control allocation, later timed reviews require fresh authority, and duplicate/busy hints create none. Preserve strict valid-head FIFO, distinguish repairable refusal from invariant fault, and bind numeric resources in N5.2.
...
- [EXP-0127](./EXP-0127.md): Use checked nonwrapping source revisions and transactional evaluate/install/revalidate/acknowledge/remove-old ordering. Keep each shared traversal target fixed, retain newer revisions as the next target, and advance only after stale proof or durable generation-bound destination authority; exhaustion remains sticky and fail-closed.
