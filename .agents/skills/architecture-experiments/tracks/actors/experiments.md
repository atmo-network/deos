...
- [EXP-0137](./EXP-0137.md): Keep one implementation baseline for stable process placement, the actor-keyed Live/Pending ring, exact revisioned Park lookup, C32 deadline pages/paged heaps and sealed reclamation. Admit one alternate only when a named structural falsifier survives one bounded correction; cost alone belongs to N6.5/N6.3.
...
| [EXP-0137](./EXP-0137.md) | 0.7.27 | Accepted | Leaf: Current-State Actors Physical-Choice Sufficiency Ledger | EXP-0120/EXP-0125/EXP-0135 selected architecture and EXP-0136 measurement boundary on baseline `d83bdb1` | Retain one implementation, bind five smallest structural falsifiers and permit only one bounded correction/alternate per falsified row | N3–N5 realization, N6.5 physical accounting, N6.3 whole-service decision and N7 review |
