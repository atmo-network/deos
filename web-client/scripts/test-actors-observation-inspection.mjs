/*
Domain: Actors observation inspection validation
...
const fanoutBudget = {
  ...
  weightIdentity: 'actor-weights@6688fe06',
...
test('typed provider reads the bounded registry and selected exact storage keys', async () => {
  ...
  assert.match(source, /Actors\.ObservationSubscriberPageLists\.getValue/);
  assert.match(source, /Actors\.ObservationSubscriberPages\.getValue/);
